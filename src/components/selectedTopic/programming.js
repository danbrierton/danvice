   ...
   return(
      <div id="progTopic">
         <div class="progTopic_categories">
            ...
            <ul>
               <li>External Philosophy: <a href="https://agilemanifesto.org/">Agile Manifesto</a> and <a href="https://agilemanifesto.org/principles.html">Agile Principles</a> by Beck, Beedle, van Bennekum, Cockburn, Cunningham, Fowler, Grenning, Highsmith, Hunt, Jeffries, Kern, Marick, Martin, Mellor, Schwaber, Sutherland, Thomas</li>
            </ul>
         </div>
         <div class="progTopic_categories">
         ...
         <div class="progTopic_categories">
            ...
            <ul>
               <li>External Article: <a href="https://www.cyberciti.biz/tips/howto-linux-unix-bash-shell-setup-prompt.html">Bash Custom Prompt (PS1)</a> by Vivek Gite</li>
            </ul>
         </div>
         <div class="progTopic_categories">
            Git and GitHub
            <ul>
               <li>External Article: <a href="https://help.github.com/en/articles/about-code-owners">About Code Owners</a> by GitHub</li>
            </ul>
         </div>
         <div class="progTopic_categories">
            HTML
            <ul>
               <li>External Article: <a href="https://internetingishard.com/html-and-css/semantic-html/">Semantic HTML</a> by Interneting Is Hard</li>
            </ul>
         </div>
         <div class="progTopic_categories">
            CSS
            <ul>
               <li>External Article: <a href="https://css-tricks.com/snippets/css/a-guide-to-flexbox/">A Complete Guide to Flexbox</a> by CSS-Tricks </li>
               <li>External Article: <a href="https://css-tricks.com/snippets/css/complete-guide-grid/">A Complete Guide to Grid</a> by CSS-Tricks </li>
            </ul>
         </div>
         <div class="progTopic_categories">
            JavaScript
